...
export default function GlitchSection({ data }: { data: ResultsData }) {
    ...
    return (
        <section className="relative min-h-screen w-full bg-zinc-950 py-24 px-6 md:px-20 z-20 overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto space-y-20 relative z-10">
                <div className="text-center">
                    <span className="block text-[10px] uppercase tracking-[0.3em] text-rose-500 mb-4 animate-pulse">Act IV : Interference Detected</span>
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                    ...
                    <FrictionCard data={mm.relationship_friction} title="Relational Signal" />
    ...
    return (
        ...
        >
            ...
            <div className="bg-zinc-900 p-4 rounded-lg border-l-2 border-emerald-500">
                <span className="text-[10px] uppercase text-emerald-500 mb-1 block tracking-wider">Debugging Patch Applied</span>
