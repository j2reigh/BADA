...
export const translations = {
  en: {
    ...
    // FAQ
    'faq.title': 'FAQ',
    'faq.q1.q': 'What is BADA report?',
    'faq.q1.a': 'A personal report based on your birth data. 3 cards free, 10 more for $2.9.',
    'faq.q2.q': 'Is this fortune telling?',
    'faq.q2.a': 'No. Nothing is predicted. We show patterns in how you operate — not what will happen to you.',
    'faq.q3.q': 'Is this actually personalized?',
    'faq.q3.a': 'Yes. Your report is generated from your specific birth data — date, time, and location. No two reports are the same. The free cards already prove it.',
    'faq.q4.q': 'What do I get for $2.9?',
    'faq.q4.a': '10 more cards: why your patterns exist, what they cost you at work, in relationships, and with money, your 10-year chapter, and one thing to change this week.',
  ...
  ko: {
    ...
    // FAQ
    'faq.title': '자주 묻는 질문',
    'faq.q1.q': 'BADA 리포트가 뭔가요?',
    'faq.q1.a': '생년월일 기반 개인 리포트입니다. 3장 무료, 10장 추가 $2.9.',
    'faq.q2.q': '점술인가요?',
    'faq.q2.a': '아닙니다. 아무것도 예측하지 않습니다. 무슨 일이 일어날지가 아니라, 당신이 어떻게 작동하는지의 패턴을 보여줍니다.',
    'faq.q3.q': '진짜 개인화된 건가요?',
    'faq.q3.a': '네. 리포트는 당신의 생년월일, 시간, 장소로 생성됩니다. 같은 리포트는 없습니다. 무료 3장이 이미 증명합니다.',
    'faq.q4.q': '$2.9으로 뭘 더 보나요?',
    'faq.q4.a': '10장 추가: 패턴이 왜 존재하는지, 직장·관계·돈에서 치르는 대가, 10년 챕터, 이번 주 바꿀 수 있는 한 가지.',
  ...
  id: {
    ...
    // FAQ
    'faq.title': 'FAQ',
    'faq.q1.q': 'Apa itu BADA report?',
    'faq.q1.a': 'Laporan personal berdasarkan data kelahiranmu. 3 kartu gratis, 10 lagi $2.9.',
    'faq.q2.q': 'Apakah ini ramalan?',
    'faq.q2.a': 'Tidak. Tidak ada yang diprediksi. Kami menunjukkan pola cara kerjamu — bukan apa yang akan terjadi.',
    'faq.q3.q': 'Apakah ini benar-benar personal?',
    'faq.q3.a': 'Ya. Laporanmu dibuat dari data kelahiranmu — tanggal, waktu, dan lokasi. Tidak ada dua laporan yang sama. 3 kartu gratis sudah membuktikannya.',
    'faq.q4.q': 'Apa yang saya dapat dengan $2.9?',
    'faq.q4.a': '10 kartu lagi: kenapa polamu ada, biayanya di kerja, hubungan, dan uang, chapter 10 tahunmu, dan satu hal yang bisa diubah minggu ini.',
